...
# Travis clone johny-c/mlcv-tutorial repository in to a local repository.
# We use a cached directory with three mlcv-tutorial repositories (one for each
...
if [[ "$SKIP_TESTS" == "true" ]]; then
    echo "No need to build mlcv when not running the tests"
else
    # Build mlcv-tutorial in the install.sh script to collapse the verbose
